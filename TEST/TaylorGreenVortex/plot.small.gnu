...
rep 'RUN_DOUBLE_SERIAL_FUSED_GNU/diagno.dat' u 1:5 w l lw 2 t " Double Precision"
rep 0.005*exp(-0.126*4*3.1415*3.1415*x/64/64) lw 3          t " Theoretical Energy decay"
#    EOF
