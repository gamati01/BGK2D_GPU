...
p 'RUN_SINGLE_SERIAL_ORIGINAL_GNU/prof_j.0000.dat' index 20 u ($2/0.1):(($1-0.5)/128) w l lw 2 t "Re=100"
rep 'ghia.y.dat' u 2:1 w p lw 5                                                                  t "Ghia,Re=100"
pause -1 "press any key to continue"
#
set xlabel "Spanwise velocity (v) "
set ylabel "direction (x) "
p 'RUN_SINGLE_SERIAL_ORIGINAL_GNU/prof_i.0000.dat' index 20 u ($3/0.1):(($1-0.5)/128) w l lw 2 t "Re=100"
